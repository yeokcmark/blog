...
description: |
  Japan's Nikkei share average sank to a nearly three-week low on Monday as a stronger yen dented the earnings outlook for the nation's exporters, with automakers leading declines. The Nikkei closed down 0.6% at 33,231.27 after earlier sliding as much as 1.22% to reach 33,023.04 for the first time since Nov. 14. The broader Topix slumped 0.83%. (Reporting from Reuters)
...
p_opt_OI_current_near <-
  ...
  scale_x_continuous(name = "strike",
                     ...
                     breaks = seq(from = 10000, to = 40000, by = 500),
                     labels = label_number(suffix = "K",
                                           scale = 1e-3))+
    theme(legend.text = element_text(size = rel(0.6)),
        legend.title = element_text(size = rel(0.6)),
