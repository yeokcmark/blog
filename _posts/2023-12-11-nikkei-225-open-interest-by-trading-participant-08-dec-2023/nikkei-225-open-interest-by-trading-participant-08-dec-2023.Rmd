---
title: "Nikkei 225 Open Interest by Trading Participant 2023-12-08"
description: |
date: 2023-12-11
categories:
  - nikkei225
...
#                          )
#          )
# # check then select necessary columns
# 
# d<-
#   d %>% 
#   select(1:3, 6)
...
# data_2401 <- d
# saveRDS(data_2401, file = "data_2311.RDS")
# 
...
x_put <- min(data_reduced$strike)
x_call <- max(data_reduced$strike)
