---
title: "Nikkei 225 Option Report 2023-11-29"
description: |
...
p_call_put_gamma <-
  ...
  scale_x_continuous(name = "Price",
                     limits = c(spot_price-3500, spot_price+2500),
                     breaks = c(30000+500*1:20),
...
p_total_gamma<-
  ...
  scale_x_continuous(name = "Price",
                     limits = c(31750, spot_price+2500),
                     breaks = c(30000+500*1:20),
                     labels = label_number(suffix = "K",
                                           scale = 1e-3)
                   )+
...
<br> Date: `r {p_date}` Contract: Dec 2023\
<br> <br>
...
<br> <br> Contract: Jan and Feb 2024\
<br> <br>
