---
title: "Nikkei 225 Option Report 2023-12-15"
description: |
date: 2023-12-15
categories:
  - nikkei225
...
```{r, layout="l-body-outset", warning=FALSE, echo = FALSE}
p_opt_volume_near
```
...
```{r, layout="l-body-outset", warning=FALSE, preview = TRUE, echo = FALSE}
p_total_gamma
```
