---
title: "Nikkei 225 Option Report 2023-12-05"
description: |
...
p_opt_volume_near <-
  ...
  scale_x_continuous(name = "strike",
                     limits = c(28000, max(d_near_volume$strike)),
                     breaks = c(27500+500*1:floor((max(d_near_volume$strike)-28000)/500)),
                     labels = label_number(suffix = "K",
                                           scale = 1e-3))+
...
p_opt_volume_far <-
  ...
  geom_vline(xintercept = spot_price,
             ...
             color = "darkgreen")+
  scale_x_continuous(name = "strike",
                     limits = c(25000, max(d_far_volume$strike)),
                     breaks = c(24500+500*1:floor((max(d_far_volume$strike)-min(d_far_volume$strike))/500)),
                     labels = label_number(suffix = "K",
                                           scale = 1e-3))+
  scale_y_continuous(name = "volume")+
  labs(title = glue("Nikkei 225 Options Daily Traded Volume - {p_date}"),
...
p_opt_change_OI_near <-
  ...
  geom_vline(xintercept = spot_price,
             ...
             color = "darkgreen")+
  scale_x_continuous(name = "strike",
                     limits = c(25000, max(d_near_oic$strike)),
                     breaks = c(24500+500*1:floor((max(d_near_oic$strike)-25000)/500)),
                     labels = label_number(suffix = "K",
                                           scale = 1e-3))+
  scale_y_continuous(name = "volume")+
...
p_opt_change_OI_far <-
  ...
  geom_vline(xintercept = spot_price,
             ...
             color = "darkgreen")+
  scale_x_continuous(name = "strike",
                     limits = c(25000, max(d_far_oic$strike)),
                     breaks = c(24500+500*1:floor((max(d_far_oic$strike)-25000)/500)),
                     labels = label_number(suffix = "K",
                                           scale = 1e-3))+
  scale_y_continuous(name = "volume")+
  labs(title = glue("Nikkei 225 Options Daily Change in Open Interest - {p_date}"),
