...
I created a workflowset, which will conveniently allow me to evaluate the rf model across both 2 recipes.
...
Hyper-parameters are mtry of 1146 and min_n of 14. Let's see if we can improve on these results by performing iterative search using `tune_bayes`.
